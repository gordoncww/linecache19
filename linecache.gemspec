...
example in a debugger where the same lines are shown many times.
  ...
  s.files = [%q{AUTHORS}, %q{COPYING}, %q{ChangeLog}, %q{NEWS}, %q{README}, %q{Rakefile}, %q{VERSION}, %q{ext/trace_nums/extconf.rb}, %q{ext/trace_nums/trace_nums.c}, %q{ext/trace_nums/trace_nums.h}, %q{lib/linecache19.rb}, %q{lib/tracelines19.rb}, %q{test/short-file}, %q{test/lnum-diag.rb}, %q{test/parse-show.rb}, %q{test/rcov-bug.rb}, %q{test/test-linecache.rb}, %q{test/test-tracelines.rb}]
  ...
  s.test_files = [%q{test/test-linecache.rb}, %q{test/test-tracelines.rb}]
